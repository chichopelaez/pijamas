          ...
          {proveedores.map((proveedor, index) => (
            <tr key={index}>
              <td className="px-6 py-4 whitespace-nowrap">
                <div className="font-medium text-gray-900">{proveedor.nombre_comercial || proveedor.nombre_legal}</div>
                <div className="text-sm text-gray-500">{proveedor.productos_servicios?.substring(0, 30)}...</div>
              </td>
              <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                {proveedor.identificacion_fiscal}
              </td>
              <td className="px-6 py-4 whitespace-nowrap">
                <div className="text-sm text-gray-900">{proveedor.contacto_nombre}</div>
